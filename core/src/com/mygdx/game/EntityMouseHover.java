...
public class EntityMouseHover extends Entity
{
    /**
     ...
     */
    public EntityMouseHover(Vector2 position, Entity.EntitySubtype subtype, Entity.EntityState state, SpriteSystem sprite_system)
    {
